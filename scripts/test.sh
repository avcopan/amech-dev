...
echo "Determining node capacities based on job memory ${JOB_MEM} and nprocs ${JOB_NPROCS}..."
SSHLOGINS=()
SSHLOGIN=""
...
echo "Manifest: ${PIXI_PROJECT_MANIFEST}"
...
parallel --sshlogin ${SSHLOGIN} "cd ${PWD} && ./scripts/_run.sh" ::: ${DIRS[*]} ::: ${PIXI_PROJECT_MANIFEST}
